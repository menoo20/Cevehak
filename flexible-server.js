    ...
    async (req, res) => {
        try {            // Prepare submission data
            ...
            const serviceMessages = {
                'cv-to-website': '🎉 تم استلام طلب تحويل السيرة إلى موقع ويب بنجاح!\n📧 ستصلك رسالة تأكيد على بريدك الإلكتروني\n📱 سنتواصل معك عبر الواتساب خلال ساعات قليلة لاستكمال التفاصيل',
                'full-package': '🎉 تم استلام طلب الباقة الكاملة بنجاح!\n📧 ستصلك رسالة تأكيد على بريدك الإلكتروني\n📱 سنتواصل معك عبر الواتساب خلال ساعات قليلة لجمع المعلومات المطلوبة',
                'cv-only': '🎉 تم استلام طلب إنشاء السيرة الذاتية بنجاح!\n📧 ستصلك رسالة تأكيد على بريدك الإلكتروني\n📱 سنتواصل معك عبر الواتساب خلال ساعات قليلة لجمع معلوماتك المهنية'
            };

            res.json({
                success: true,
                message: serviceMessages[req.serviceType] || '🎉 تم استلام طلبك بنجاح! سنتواصل معك عبر الواتساب قريباً 📱',
